...
- [ ] **6.9-bis 11g.2.f** Audit + regression.  Land
    ...
    DIVERGE / 0 ERROR (corpus = 92); TestExplainParity 596 PASS / 1
    DIVERGE / 0 ERROR (corpus = 597); TestWherePlanner 675/675.**
...
- [ ] **6.10** `TestExplainParity.pas` — full SQL corpus EXPLAIN diff.
  ...
  Current Status (2026-04-27): **596 PASS / 1 DIVERGE / 0 ERROR**
  (corpus = 597 after probe sweep #22).
  ...
  isolation and shrinks Δ by a known amount):
    ...
    - [ ] **6.10 step 6** Expand corpus further and drive remaining
      ...
      Corpus now 596 PASS / 1 DIVERGE / 597 total after probe
      sweeps #18..#22 (each added 25–30 PASS rows).  The pattern:
