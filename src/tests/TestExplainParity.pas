...
begin
  ...
  { Probe sweep #32 — additional adjacent shapes mirroring sweeps #27..#31. }
  Add(i, 'SELECT 16+16',                'SELECT 16+16;');                        Inc(i);
  Add(i, 'SELECT 350-35',               'SELECT 350-35;');                       Inc(i);
  Add(i, 'SELECT 13*13',                'SELECT 13*13;');                        Inc(i);
  Add(i, 'SELECT 256/16',               'SELECT 256/16;');                       Inc(i);
  Add(i, 'SELECT 31%8',                 'SELECT 31%8;');                         Inc(i);
  Add(i, 'SELECT 1+2+3+4+5+6+7',        'SELECT 1+2+3+4+5+6+7;');                Inc(i);
  Add(i, 'SELECT -10+10',               'SELECT -10+10;');                       Inc(i);
  Add(i, 'SELECT -8*-9',                'SELECT -8*-9;');                        Inc(i);
  Add(i, 'SELECT a+7',                  'SELECT a+7 FROM t;');                   Inc(i);
  Add(i, 'SELECT a-7',                  'SELECT a-7 FROM t;');                   Inc(i);
  Add(i, 'SELECT a*7',                  'SELECT a*7 FROM t;');                   Inc(i);
  Add(i, 'SELECT a/7',                  'SELECT a/7 FROM t;');                   Inc(i);
  Add(i, 'SELECT b-5',                  'SELECT b-5 FROM t;');                   Inc(i);
  Add(i, 'SELECT c*6',                  'SELECT c*6 FROM t;');                   Inc(i);
  Add(i, 'SELECT a WHERE rowid=43',     'SELECT a FROM t WHERE rowid=43;');      Inc(i);
  Add(i, 'SELECT a WHERE rowid=44',     'SELECT a FROM t WHERE rowid=44;');      Inc(i);
  Add(i, 'SELECT a WHERE rowid=45',     'SELECT a FROM t WHERE rowid=45;');      Inc(i);
  Add(i, 'SELECT a WHERE a=23',         'SELECT a FROM t WHERE a=23;');          Inc(i);
  Add(i, 'SELECT a WHERE a=24',         'SELECT a FROM t WHERE a=24;');          Inc(i);
  Add(i, 'SELECT a WHERE a=25',         'SELECT a FROM t WHERE a=25;');          Inc(i);
  Add(i, 'INSERT t 33 66 99',           'INSERT INTO t VALUES(33,66,99);');      Inc(i);
  Add(i, 'INSERT t 34 68 102',          'INSERT INTO t VALUES(34,68,102);');     Inc(i);
  Add(i, 'INSERT alt 76 86 96',         'INSERT INTO s VALUES(76,86,96);');      Inc(i);
  Add(i, 'INSERT alt -15 -25 -35',      'INSERT INTO s VALUES(-15,-25,-35);');   Inc(i);
  Add(i, 'DELETE rowid=129',            'DELETE FROM t WHERE rowid=129;');       Inc(i);
  Add(i, 'DELETE rowid=130',            'DELETE FROM t WHERE rowid=130;');       Inc(i);
  Add(i, 'DELETE s rowid=47',           'DELETE FROM s WHERE rowid=47;');        Inc(i);
  Add(i, 'SAVEPOINT spAA',              'SAVEPOINT spAA;');                      Inc(i);
  Add(i, 'RELEASE spAA',                'RELEASE spAA;');                        Inc(i);
  Add(i, 'SAVEPOINT eighteen',          'SAVEPOINT eighteen;');                  Inc(i);

  { Probe sweep #33 — additional adjacent shapes mirroring sweeps #27..#32. }
  Add(i, 'SELECT 17+17',                'SELECT 17+17;');                        Inc(i);
  Add(i, 'SELECT 360-36',               'SELECT 360-36;');                       Inc(i);
  Add(i, 'SELECT 14*14',                'SELECT 14*14;');                        Inc(i);
  Add(i, 'SELECT 288/16',               'SELECT 288/16;');                       Inc(i);
  Add(i, 'SELECT 33%8',                 'SELECT 33%8;');                         Inc(i);
  Add(i, 'SELECT 2+3+4+5+6+7+8',        'SELECT 2+3+4+5+6+7+8;');                Inc(i);
  Add(i, 'SELECT -11+11',               'SELECT -11+11;');                       Inc(i);
  Add(i, 'SELECT -7*-8',                'SELECT -7*-8;');                        Inc(i);
  Add(i, 'SELECT a+8',                  'SELECT a+8 FROM t;');                   Inc(i);
  Add(i, 'SELECT a-8',                  'SELECT a-8 FROM t;');                   Inc(i);
  Add(i, 'SELECT a*8',                  'SELECT a*8 FROM t;');                   Inc(i);
  Add(i, 'SELECT a/8',                  'SELECT a/8 FROM t;');                   Inc(i);
  Add(i, 'SELECT b-6',                  'SELECT b-6 FROM t;');                   Inc(i);
  Add(i, 'SELECT c*7',                  'SELECT c*7 FROM t;');                   Inc(i);
  Add(i, 'SELECT a WHERE rowid=46',     'SELECT a FROM t WHERE rowid=46;');      Inc(i);
  Add(i, 'SELECT a WHERE rowid=47',     'SELECT a FROM t WHERE rowid=47;');      Inc(i);
  Add(i, 'SELECT a WHERE rowid=48',     'SELECT a FROM t WHERE rowid=48;');      Inc(i);
  Add(i, 'SELECT a WHERE a=26',         'SELECT a FROM t WHERE a=26;');          Inc(i);
  Add(i, 'SELECT a WHERE a=27',         'SELECT a FROM t WHERE a=27;');          Inc(i);
  Add(i, 'SELECT a WHERE a=28',         'SELECT a FROM t WHERE a=28;');          Inc(i);
  Add(i, 'INSERT t 35 70 105',          'INSERT INTO t VALUES(35,70,105);');     Inc(i);
  Add(i, 'INSERT t 36 72 108',          'INSERT INTO t VALUES(36,72,108);');     Inc(i);
  Add(i, 'INSERT alt 77 87 97',         'INSERT INTO s VALUES(77,87,97);');      Inc(i);
  Add(i, 'INSERT alt -16 -26 -36',      'INSERT INTO s VALUES(-16,-26,-36);');   Inc(i);
  Add(i, 'DELETE rowid=131',            'DELETE FROM t WHERE rowid=131;');       Inc(i);
  Add(i, 'DELETE rowid=132',            'DELETE FROM t WHERE rowid=132;');       Inc(i);
  Add(i, 'DELETE s rowid=48',           'DELETE FROM s WHERE rowid=48;');        Inc(i);
  Add(i, 'SAVEPOINT spBB',              'SAVEPOINT spBB;');                      Inc(i);
  Add(i, 'RELEASE spBB',                'RELEASE spBB;');                        Inc(i);
  Add(i, 'SAVEPOINT nineteen',          'SAVEPOINT nineteen;');                  Inc(i);

  { Probe sweep #34 — additional adjacent shapes mirroring sweeps #27..#33. }
  Add(i, 'SELECT 19+19',                'SELECT 19+19;');                        Inc(i);
  Add(i, 'SELECT 400-40',               'SELECT 400-40;');                       Inc(i);
  Add(i, 'SELECT 15*15',                'SELECT 15*15;');                        Inc(i);
  Add(i, 'SELECT 256/8',                'SELECT 256/8;');                        Inc(i);
  Add(i, 'SELECT 41%9',                 'SELECT 41%9;');                         Inc(i);
  Add(i, 'SELECT 1+2+3+4+5+6+7+8+9',    'SELECT 1+2+3+4+5+6+7+8+9;');            Inc(i);
  Add(i, 'SELECT -13+13',               'SELECT -13+13;');                       Inc(i);
  Add(i, 'SELECT -9*-10',               'SELECT -9*-10;');                       Inc(i);
  Add(i, 'SELECT a+9',                  'SELECT a+9 FROM t;');                   Inc(i);
  Add(i, 'SELECT a-9',                  'SELECT a-9 FROM t;');                   Inc(i);
  Add(i, 'SELECT a*9',                  'SELECT a*9 FROM t;');                   Inc(i);
  Add(i, 'SELECT a/9',                  'SELECT a/9 FROM t;');                   Inc(i);
  Add(i, 'SELECT b-7',                  'SELECT b-7 FROM t;');                   Inc(i);
  Add(i, 'SELECT c*8',                  'SELECT c*8 FROM t;');                   Inc(i);
  Add(i, 'SELECT a WHERE rowid=49',     'SELECT a FROM t WHERE rowid=49;');      Inc(i);
  Add(i, 'SELECT a WHERE rowid=50',     'SELECT a FROM t WHERE rowid=50;');      Inc(i);
  Add(i, 'SELECT a WHERE rowid=51',     'SELECT a FROM t WHERE rowid=51;');      Inc(i);
  Add(i, 'SELECT a WHERE a=29',         'SELECT a FROM t WHERE a=29;');          Inc(i);
  Add(i, 'SELECT a WHERE a=30',         'SELECT a FROM t WHERE a=30;');          Inc(i);
  Add(i, 'SELECT a WHERE a=31',         'SELECT a FROM t WHERE a=31;');          Inc(i);
  Add(i, 'INSERT t 37 74 111',          'INSERT INTO t VALUES(37,74,111);');     Inc(i);
  Add(i, 'INSERT t 38 76 114',          'INSERT INTO t VALUES(38,76,114);');     Inc(i);
  Add(i, 'INSERT alt 78 88 98',         'INSERT INTO s VALUES(78,88,98);');      Inc(i);
  Add(i, 'INSERT alt -17 -27 -37',      'INSERT INTO s VALUES(-17,-27,-37);');   Inc(i);
  Add(i, 'DELETE rowid=133',            'DELETE FROM t WHERE rowid=133;');       Inc(i);
  Add(i, 'DELETE rowid=134',            'DELETE FROM t WHERE rowid=134;');       Inc(i);
  Add(i, 'DELETE s rowid=49',           'DELETE FROM s WHERE rowid=49;');        Inc(i);
