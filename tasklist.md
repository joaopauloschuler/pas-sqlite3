...
- [ ] **6.9-bis 11g.2.f** Audit + regression.  Land
    ...
    DIVERGE / 0 ERROR (corpus = 92); TestExplainParity 566 PASS / 1
    DIVERGE / 0 ERROR (corpus = 567); TestWherePlanner 675/675.**
...
- [ ] **6.10** `TestExplainParity.pas` — full SQL corpus EXPLAIN diff.
  ...
  Current Status (2026-04-27): **566 PASS / 1 DIVERGE / 0 ERROR**
  (corpus = 567 after probe sweep #21).
  ...
  isolation and shrinks Δ by a known amount):
    ...
    - [ ] **6.10 step 6** Expand corpus further and drive remaining
      ...
      Corpus now 566 PASS / 1 DIVERGE / 567 total after probe
      sweeps #18..#21 (each added 25–30 PASS rows).  The pattern:
