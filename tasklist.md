...
- [ ] **6.10** `TestExplainParity.pas`
  ...
  [ ] **6.12** port sqlite3Pragma in full.  Regression gate
       ...
       driven to 29 DIVERGE via a table-driven PragTyp_FLAG arm
       (codegen.pas sqlite3Pragma).  17 boolean PRAGMAs covered today:
       ...
       ignore_check_constraints, query_only, trusted_schema,
       count_changes, read_uncommitted, empty_result_callbacks.
       ...
       Remaining divergences (29): table-valued pragma_* introspection
       ...
       wal_autocheckpoint / journal_size_limit, secure_delete /
       temp_store / threads.
